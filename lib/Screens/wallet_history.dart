...
import 'package:deliveryboy_multivendor/Screens/pay_admin.dart';
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          //             ),
          //             Text(CUR_CURRENCY! + " " + CASH_RECIEVED,
          //                 style: Theme.of(context)
          //                     .textTheme
          //                     .headline6!
          //                     .copyWith(
          ...
          //               onBtnSelected: () {
          //                 _payToAdminDialog();
          //              //  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> PayAdmin()));
          //               },
          //             ),
          //           ],
          //         ),
