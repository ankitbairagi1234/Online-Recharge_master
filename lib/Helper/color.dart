...
const Color primary = Color(0xffE7873B);
const Color secondary=Color(0xffFBFA0D);
const Color fontColor=Colors.black;
const Color grad1Color=Color(0xffE7873B);
const Color grad2Color=Color(0xffE7873B);
const Color lightWhite2=Color(0xffEEF2F3);

const Color disableColor=Color(0xffEEF2F9);
const Color pink=Color(0xffE7873B);
