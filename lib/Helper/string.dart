...
final Uri dailyCollectionApi =Uri.parse( baseUrl + 'daily_collection');
...
final Uri callAdminApi = Uri.parse(baseUrl + 'call_request');
final Uri onlineOfflineApi = Uri.parse(baseUrl + 'delivery_boy_online_offline');
final Uri acceptRejectApi = Uri.parse(baseUrl + 'accept_reject_order');
final Uri sendWithReqApi = Uri.parse(baseUrl + 'send_withdrawal_request');
final Uri getWorkingHours = Uri.parse(baseUrl + 'get_working_hours');
final Uri getWithReqApi = Uri.parse(baseUrl + 'get_withdrawal_request');
final Uri getAcceptRejectOrder = Uri.parse(baseUrl + 'accept_reject_order');
final Uri setRatingApi = Uri.parse(baseUrl + 'user_seller_rating');
...
const String CASH = 'cash_received';
...
const String GST = 'gst_service_charge_amount';
